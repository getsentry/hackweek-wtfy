<script lang="ts">
	...
	const variants = {
		...
		secondary: 'text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 focus:ring-indigo-500 border-gray-300 dark:border-gray-600'
	};
